...
def phruscle():
    """
    This script run muscle and phred, and uses pandas to make a clean table of it.
    """


@phruscle.command('basecall')
@click.option('--input', help="Input sequence in ab1 or abi format")
...
#+BEGIN_SRC python :tangle src/phruscle
...
@click.options('-i', '--input', help="The abi file to make table with")

...
@click.argument('-i', '--input', help="Input sequence in ab1 or abi format")
@click.argument('-r', '--ref', help="Reference alignment in fasta format")
...
@click.argument('-i', '--input', help="The abi file to make table with")
@click.argument('-o',
                '--output',
                type=click.File('w'),
                default='-',
                required=False,
                help="The abi file to make table with")
